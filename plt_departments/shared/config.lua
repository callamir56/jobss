...
Config.Translations = {
    ['en'] = {
        ...
        ["k9_attack"] = "Attack",
        ["k9_attack_nearest"] = "Attack Nearest",
        ["k9_hunt_by_id"] = "Attack / Track by ID",
        ["k9_sit"] = "Sit",
        ["k9_track_nearest"] = "Track Nearest Person",
        ["k9_open_menu"] = "Open K9 Menu",
        ["k9_command_title"] = "K9 COMMAND",
        ["k9_player_id_label"] = "PLAYER ID",
        ["k9_track_usage"] = "Usage: /k9track <player id>",
        ["k9_attack_usage"] = "Usage: /k9attack <player id>",
        ["k9_tracking_player"] = "K9 is tracking player {id}...",
        ["k9_hunting_player"] = "K9 is hunting player {id}...",
        ...
        ["k9_sat"] = "Dog sat down.",
        ["k9_entering_vehicle"] = "Dog is in the vehicle.",
