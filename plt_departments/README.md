...
- 🚗 **سوار/پیاده کردن:** سگ رو سوار ماشینی که خودت توشی می‌کنه (اگه پیاده باشی، نزدیک‌ترین ماشین)؛ اگه سگ توی ماشین باشه پیاده‌ش می‌کنه
- 💥 **حمله:** به نزدیک‌ترین پلیر (زیر ۱۰ متر) حمله می‌کنه
- 🪑 **نشستن:** سگ می‌شینه
- 🎯 **ردیابی نزدیک‌ترین فرد:** سگ نزدیک‌ترین پلیر رو پیدا می‌کنه و پیاده میره سمتش
...
/k9track 2
```
اگه پلیر آیدی ۲ تا ۱۰۰ متر نزدیکت باشه، سگ **پیاده (راه رفتن)** میره سمتش و وقتی رسید **می‌شینه و وایمیسته**. اگه دورتر از ۱۰۰ متر باشه یا توی استریم نباشه، نوتیف خطا میاد.
